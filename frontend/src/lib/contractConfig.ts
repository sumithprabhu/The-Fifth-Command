...
export const CONTRACT_ABI = [
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "enum TheFifthCommand.GameState",
				"name": "",
				"type": "uint8"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct TheFifthCommand.GameResult",
				"name": "",
				"type": "tuple"
			}
		],
