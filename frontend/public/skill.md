...
### Contract Address
**Game Contract:** `0x6B9afDe0d0ab03a2c2aB65ad8b5E7C86A17257CA`

### Join Game Function
**ABI (one line):** `{"inputs":[],"name":"joinGame","outputs":[],"stateMutability":"payable","type":"function"}`

**Contract Address:** `0x6B9afDe0d0ab03a2c2aB65ad8b5E7C86A17257CA`

### Entry Fee
**Entry Fee:** 10 MON (native gas token)

**Important:** No token approval is needed. The game uses the native gas token (MON) for entry fees. Simply ensure your wallet has at least 10 MON plus gas fees before calling `joinGame()`.
...
- Pay `entryFee` of 10 MON (native gas token) - no token approval needed  
